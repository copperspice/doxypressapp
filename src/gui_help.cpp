...
// BROOM
   ...
   s_fullHelp.insert("REPEAT_BRIEF",
      ...
      "<br><br>"
      "Note: If both 'HIDE UNDOCUMENTED MEMBERS' and 'BRIEF DESCRIPTION' are set to NO, the "
  ...
  s_fullHelp.insert("ALWAYS_DETAILED_SEC",
   ...
   s_fullHelp.insert("FULL_PATH_NAMES",
      ...
      "before files names in the file list and in the header files. If not set, the "
  ...
  s_fullHelp.insert("DUPLICATE_DOCS",
   ...
   s_fullHelp.insert("EXTRACT_LOCAL_METHODS",
      ...
      "included in the documentation. If not set, only methods in the interface are included. "
      "<br><br>"
      "The default value is: NO");
   ...
   s_fullHelp.insert("SORT_MEMBERS_CTORS_FIRST",
      ...
      "constructors will appear in the respective orders defined by 'SORT BRIEF DOCUMENTATION' and 'SORT MEMBER DOCUMENTATION'. "
      "<br><br>"
      "If 'SORT BRIEF DOCUMENTATION' is set to NO, this tag is ignored for sorting brief member documentation. "
      "<br>"
      "If 'SORT MEMBER DOCUMENTATION' is set to NO this tag is ignored for sorting detailed member documentation. "
      "<br><br>"
      "The default value is: NO");

   s_fullHelp.insert("SORT_GROUP_NAMES",
      "If this tag is set DoxyPress will sort the hierarchy of group names alphabetical. "
  ...
  s_fullHelp.insert("FILE_VERSION_FILTER",
   ...
   s_fullHelp.insert("INPUT_PATTERNS",
      "If the 'INPUT SOURCE FILES OR DIRECTORIES' tag contains directories, this tag is used to "
   ...
   s_fullHelp.insert("EXCLUDE_FILES",
      ...
      "the 'INPUT SOURCE FILES OR DIRECTORIES' tag. "
      "<br><br>"
   ...
   s_fullHelp.insert("EXCLUDE_PATTERNS",
      "If the 'INPUT SOURCE FILES OR DIRECTORIES' tag contains directories, this tag will be used to "
   ...
   s_fullHelp.insert("EXAMPLE_SOURCE",
      "Used  to specify one or more files or directories which contain example code fragments. "
   ...
   s_fullHelp.insert("EXAMPLE_RECURSIVE",
      "If this tag is set then example source code will be searched recursively for the "
   ...
   s_fullHelp.insert("REF_LINK_SOURCE",
      "If this tag is set and 'SOURCE BROWSER' is set, the hyperlinks from functions "
...
// BROOM
   s_fullHelp.insert("USE_HTAGS",
      ...
      "the htags(1) tool. The result is, instead of the source browser generated by DoxyPress, the links to "
...
// broom
   s_fullHelp.insert("SEARCH_INCLUDES",
      "If this tag is set the files specified in the 'INCLUDE PATH' tag will be "
   ...
   s_fullHelp.insert("INCLUDE_FILE_PATTERNS",
      ...
      "specified with the 'FILE PATTERNS' tag (located on Input Part 2) will be used. "
      "<br><br>"
      "This tag requires the tag 'ENABLE PREPROCESSING' is set to YES");
...
// BROOM
   s_fullHelp.insert("EXPAND_AS_DEFINED",
      "If the 'MACRO EXPANSION' and 'EXPAND ONLY PREDEFINED MACROS' tags are set to YES, then this "
      "tag is used to specify a list of macro names which should be expanded. The "
      "macro definition found in the sources will be used. Use the 'PREDEFINED MACROS' "
      "tag to use a different macro definition which overrules the definition found in the source code. "
      "<br><br>"
      "This tag requires the tag 'ENABLE PREPROCESSING' is set to YES"); 
   ...
   s_fullHelp.insert("MSCGEN_PATH",
      ...
      "DoxyPress will run the mscgen tool to produce the chart and insert it in the documentation. "
   ...
   s_fullHelp.insert("DOT_CLASS_GRAPH",
      "If this tag is set DoxyPress will generate a graph for "
   ...
   s_fullHelp.insert("DOT_INCLUDE",
      "If the 'INCLUDE GRAPH', 'ENABLE PREPROCESSING' and 'SEARCH INCLUDES' tags are set to "
   ...
   s_fullHelp.insert("DOT_INCLUDED_BY",
      "If the 'INCLUDED BY GRAPH', 'ENABLE PREPROCESSING' and 'SEARCH INCLUDES' tags are "
   ...
   s_fullHelp.insert("DOT_IMAGE_FORMAT",
      ...
      "to ensure the SVG files are visible in IE. "
      "<br><br>"
   ...
   s_fullHelp.insert("INTERACTIVE_SVG",
      ...
      "enable the generation of interactive SVG images which allow zooming and panning. "
      "If you select 'svg' also set 'HTML FILE EXTENSION' to 'xhtml' in order "
      "to ensure the SVG files are visible in IE. "
      "<br><br>"
      "The default value is: NO "
   ...
   s_fullHelp.insert("DISABLE_INDEX",
      ...
      "tree, you can set this option to YES if you also set 'GENERATE TREEVIEW' to YES. "
      "<br><br>"
      "The default value is: NO "
      "<br>"
      "This tag requires the tag 'GENERATE HTML' is set to YES");
...
// BROOM
   s_fullHelp.insert("GEN_TREEVIEW",
      "This tag is used to specify whether a tree-like index structure should be generated to "
      "display hierarchical information. If the tag is set a side panel will be generated which "
      "contains tree like index structure. The user's browser must support JavaScript, DHTML, CSS and frames. "
      "Windows users are probably better off using the HTML help feature. Via custom stylesheets one can "
      "further fine tune the look of the index. As an example, the default style "
      "sheet generated by DoxyPress has an example that shows how to put an image at "
      "the root of the tree instead of the 'PROJECT NAME'. Since the tree basically has "
      "the same information as the tab index, you could consider setting 'DISABLE INDEX' to YES when enabling this option. "
      "<br><br>"
      "The default value is: NO "
      "<br>"
      "This tag requires the tag 'GENERATE HTML' is set to YES");
   ...
   s_fullHelp.insert("TREEVIEW_WIDTH",
      "If 'GENERATE TREEVIEW' is enabled this tag can be used "
...
// BROOM
   s_fullHelp.insert("SEARCH_EXTERNAL_ID",
      ...
      "as an identifier. This is useful in combination with 'EXTRA SEARCH MAPPINGS' to search through "
...
// BROOM
   ...
   s_fullHelp.insert("USE_MATHJAX",
      ...
      "to it using the 'MATHJAX RELPATH' option. "
      "<br><br>"
      "The default value is: NO "
      "<br>"
      "This tag requires the tag 'GENERATE HTML' is set to YES");
   ...
   s_fullHelp.insert("LATEX_HEADER",
      ...
      "string for the replacement values of the other commands the user is referred to 'HTML HEADER'. "
      "<br><br>"
   ...
   s_fullHelp.insert("LATEX_EXTRA_FILES",
      ...
      "other source files which should be copied to the 'LATEX OUTPUT' "
   ...
   s_fullHelp.insert("LATEX_PDF",
      "If this tag is set then DoxyPress will use 'pdf latex' to generate the PDF file "
