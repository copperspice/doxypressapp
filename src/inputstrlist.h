...
class InputStrList : public QObject, public Input
{
 ...
 private :
   CS_SLOT_1(Private, void addString())
   CS_SLOT_2(addString)
   CS_SLOT_1(Private, void delString())
   CS_SLOT_2(delString)
   CS_SLOT_1(Private, void updateString())
   CS_SLOT_2(updateString)
   CS_SLOT_1(Private, void selectText(const QString &s))
   CS_SLOT_2(selectText)
   CS_SLOT_1(Private, void browseFiles())
   CS_SLOT_2(browseFiles)
   CS_SLOT_1(Private, void browseDir())
   CS_SLOT_2(browseDir)
