...
static void configFullHelp()
{
   ...
   m_fullHelp.insert("PROJECT_LOGO",
...
doc->add(
            ...
            "exclude all test directories for example use the pattern *\/test/*");      TAKE OUT THE \
...
doc->add(
            ...
            "\n"
            "Note that the wildcards are matched against the file with absolute path, so to\n"
            "exclude all test directories use the pattern *\/test/*");      TAKE OUT THE \
